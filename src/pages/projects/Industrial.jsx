...
const projectsData = [
  {
    name: 'Indamer',
    location: 'Mumbai',
    image: '/images/industrial/indamer/Picture4.jpg',
    link: './subprojects/saraswatiheight'
  },
  {
    name: 'Urban Rise',
    location: 'Pune',
    image: '/images/saraswati_heights/Picture13.jpg',
...
const Industrial = () => {
  return (
    <div className="pt-[120px] px-[120px] pb-[60px] font-sans text-[#222]">
      <h1 className="text-[40px] font-bold text-center mb-[40px]">Industrial</h1>
